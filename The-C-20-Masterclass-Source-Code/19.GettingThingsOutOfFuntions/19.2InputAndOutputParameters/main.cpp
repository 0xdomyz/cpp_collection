...
void max_str(std::string input1, const std::string &input2,
			 std::string &output)
{
	if (input1 > input2)
	{
...
void max_int(int input1, const int &input2, int &output)
{
	if (input1 > input2)
	{
		output = input1;
...
void max_double(double &input1, const double input2, double *output)
{
	if (input1 > input2)
	{
		*output = input1;
...
int main()
{
	...
	std::cout << "max_double is not: " << out_double << std::endl;
