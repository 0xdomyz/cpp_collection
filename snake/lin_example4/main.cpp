...
public:
    ...
    { // Set new face if it's not reversed
    ...
    { // return 1 if the snake takes food
        int next = next_head();
        if (having(next))
        {
            is_alive = 0;
        } // Die on collision itself
        else
        {
...
public:
    ...
    void re_draw()
    {
        ...
        do
        {
            ...
            cout << (field_cell == food_cell ? " @ " : snake.head() == field_cell ? " o "
